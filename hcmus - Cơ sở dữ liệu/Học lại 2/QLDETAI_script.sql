...
(
	...
	TEN nvarchar(40),
	NGSINH date,
	PHAI nchar(3) CHECK (PHAI IN ('Nam', 'Nữ')),
...
VALUES
	...
	('001', N'Thủy', '12/08/1994', 'Nữ'),
	('003', N'Hà', '09/03/1998', 'Nữ'),
	('003', N'Thu', '09/03/1998', 'Nữ'),
	('007', N'Mai', '03/26/2003', 'Nữ'),
	('007', N'Vy', '02/14/2000', 'Nữ'),
	('008', N'Nam', '05/06/1991', 'Nam'),
	('009', N'An', '08/19/1996', 'Nam'),
	('010', N'Nguyệt', '01/14/2006', 'Nữ');
GO
